...
// Consultar la base de datos para obtener el departamento del usuario
$query = "SELECT departamento FROM usuarios WHERE id_usuario = $id_usuario";
...
if ($result && mysqli_num_rows($result) > 0) {
    ...
    switch ($departamento) {
        case 'General':
            header("Location: recursos/recursos_general.php");
            break;
        case 'Diseño':
            header("Location: recursos/recursos_diseno.php");
            break;
        case 'Publicidad':
            header("Location: recursos/recursos_publicidad.php");
            break;
        case 'Ingenieria':
            header("Location: recursos/recursos_ingenieria.php");
            break;
        case 'Administracion':
            header("Location: recursos/recursos_administracion.php");
            break;
        default:
            echo "Departamento no reconocido.";
            break;
    }
    exit();
} else {
