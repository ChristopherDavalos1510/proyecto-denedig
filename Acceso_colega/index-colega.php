...
<div id="publicacionesCarousel" class="carousel slide" data-ride="carousel" style= "margin-left: -80px;">
    <div class="carousel-inner">
        <?php
        include '../funciones/conecPublicaciones.php';
        $sql="SELECT id, titulo, descripcion, imagen, megusta, corazon, felicitacion FROM publicaciones WHERE estado = 3 ORDER BY id DESC";
        $result=mysqli_query($conexion,$sql);
        $count = 0;
        while($fila=mysqli_fetch_array($result)){
            if ($count % 2 == 0) {
                echo '<div class="carousel-item' . ($count == 0 ? ' active' : '') . '">';
                echo '<div class="container-tarjeta">';
            }
            ?>
                    ...
                    <table class="table">
                        <thead>
                            <tr>
                                <th>
                                    <div class="raccion">
                                        <?php echo $fila['megusta']; ?>
                                        <div class="texto-reaccion">Like</div>
                                    </div>
                                </th>
                                <th>
                                    <div class="raccion">
                                        <?php echo $fila['corazon']; ?>
                                        <div class="texto-reaccion">Corazon</div>
                                    </div>
                                </th>
                                <th>
                                    <div class="raccion">
                                        <?php echo $fila['felicitacion']; ?>
                                        <div class="texto-reaccion">felicitaciones</div>
                                    </div>
                                </th>
                            </tr>
                        </thead>
                            ...
                            <tr>
                                <td>
                                    <div class="reacciones">
                                        <form class="reaccion" action="reacciones.php" method="POST">
    ...
    <a class="carousel-control-prev" href="#publicacionesCarousel" role="button" data-slide="prev">
        <span class="carousel-control-prev-icon" aria-hidden="true"></span>
        <span class="sr-only">Anterior</span>
    </a>
    <a class="carousel-control-next" href="#publicacionesCarousel" role="button" data-slide="next" >
        ...
        <div class="col-lg-6 col-12 mb-5 mb-lg-0 text-center">
            <img src="../images/Ordenador.webp" alt="Imagen" class="img-fluid rounded-circle mt-5" style="margin-top: 230px !important; width: 300px; height: 300px; object-fit: cover; border-radius: 50%;">
            <h1 class="hero-title text-white mt-4 mb-4" style="margin-top: 100px !important; font-size: 3rem;">
                    <br> Plataforma interna<br> DENEDIG SAS de CV
                </h1>
        </div>
        </div>
        <!--Inicio codigo de tarjetas y funcionalidad-->
  
<!--Fin codigo de tarjetas y funcionalidad-->
