...
<head>
    ...
    <title>Tutorial compresión.</title>
    <!-- CSS FILES -->
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="text-center col-lg-12 col-1 mb-1 ">
                <h1 class="text-white">Tutorial de compresión.</h1>
            </div>
        </div>
    </div>
...
<body class="Creador-y-desarrollador-page" id="top">
    ...
    <br><br>
                ...
                <h7 style="font-family: 'Baloo 2', cursive; font-size: 1.5em;">
                    Con la finalidad de tener un sistema liviano y eficaz pedimos que los archivos PDF que vas a subir a continuación no pesen más de 500 kilobytes

                    <p></p>
                    no está en caso de que no sepas cómo hacerlo este tutorial te ayudará a comprender rápidamente cómo lo puedes hacer completamente gratuito y con una web segura

                    <p></p>
                    lo único que tienes que hacer es entrar a la siguiente liga <a style="color: #f65129;" href="https://www.ilovepdf.com/es/comprimir_pdf" target ="blank">Compresor de PDF</a> y tendrás que subir el documento que deseas comprimir una vez esté arriba le das en comprimir y la misma web te dará la opción de descargar tu archivo ya comprimido con esto tus archivos no perderán calidad pero sí perderán peso

                    <p></p>
                    es importante recalcar que si tus archivos pesan más de 500 kilobytes no podrán ser subidos al sistema ya que este está automatizado y rechazará tus documentos y no serán posible que los subas 

                    <p></p>
                    esperemos este tutorial te ayude si requieres un ejemplo visual puedes consultar el apartado de capacitaciones compresión de documentos PDF
                    <p></p>
                    </h7>
                
                <br><br>
          
                                <a href="documentacion.php" class="btn btn-primary btn-lg btn-block" style="background-color: #f65129; border-color: #f65129;">Subir documentos</a>
